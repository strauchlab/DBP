...
topology = "H18p,L1,H18p,L1,H18p" #"E7,L1,H14p,L2,M,E1"
topology2 = "" #"L3,H14p,L4,E7"

L1 = ['BB','B','GBB','GB', 'G','GABB']
...
def command_line(cdir,pdb,bp,res_start,res_stop):
    ...
    command += " /work/tlinsky/Rosetta/main/source/bin/rosetta_scripts.default.linuxgccrelease -nstruct 20 -jd2:ntrials 1 -parser:protocol"
    command += " desHHH.xml -database /work/tlinsky/Rosetta/main/database  -s " + bp + ".pdb " + " -mute all -parser:script_vars blue=" + bp +".blue "
...
outdirectory = 'sample_topos_two_2'# + topology
